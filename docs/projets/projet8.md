...
[![Jordan](images/Jordan_tiktok_cover.png){: style="float: left ; margin-right: 20px;"  }](video/Jordan_tiktok.mp4 "Redirect Jordan Video"){:target="_blank" embed controls }  

J’ai créé des vidéos TikTok qui racontent l’histoire de personnalités célèbres, en utilisant des outils d’intelligence artificielle pour produire un contenu visuel et narratif captivant.  
Voici les étapes que j’ai suivies :
### Rédaction du script :
J’ai utilisé [ChatGPT](https://chatgpt.com/){:target="_blank"} pour créer des scripts engageants qui racontent l’histoire des personnalités choisies. Cet outil me permet d’obtenir rapidement un contenu bien structuré et clair, adapté à une courte vidéo.
...
[:octicons-arrow-right-16: lien des autres videos sur tiktok](https://www.tiktok.com/@histoires_de_legende?is_from_webapp=1&sender_device=pc ){:target="_blank" .md-button .md-button--primary }